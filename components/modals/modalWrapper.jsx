...
export default function ModalWrapper({text , display , displayHandler , children}) {
  return (
    ...
    <div className={`rounded-t-3xl w-full bg-secondary-800 z-40 p-3 spcae-y-2 text-primary-800 fixed left-0 bottom-0 transition-all duration-300 -mb-[50rem] ${display && 'mb-0'}`}>
