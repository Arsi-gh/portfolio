...
export default function ProjectPreview({resCss}) {
  return (
    <div className={`${resCss} text-secondary-300 border font-semibold rounded-xl p-3 size-96 min-h-96 overflow-hidden relative`}>
