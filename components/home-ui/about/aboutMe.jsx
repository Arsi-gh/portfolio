  ...
  return (
    ...
    <section className='my-28 2xl:max-w-screen-2xl max-w-screen-xl px-12 mx-auto flex items-center justify-between gap-x-4 text-primary-800 max-md:flex-col max-md:mt-3 max-md:px-4'>
        <div className='w-1/2 max-md:w-full'>
            <p className='font-semibold text-4xl drop-shadow-lg max-md:text-center max-lg:text-4xl max-md:text-xl'>I’m currently a freelance front-end developer, creating applications and assisting businesses in optimizing their projects and fulfilling other requests. If there’s anything I can do for you, don’t hesitate to reach out</p>
